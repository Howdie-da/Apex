                  ...
                  >
                    ...
                    {msg.replyToMessage &&
                      (() => {
                        ...
                        return (
                          <div
                            className={`p-2 mb-1.5 flex flex-col min-w-0 max-w-full overflow-hidden border ${
                              isReplyMine
                          ...
                          >
                            ...
                            >
                              {msg.replyToMessage.content.length > 15
                                ? msg.replyToMessage.content.slice(0, 15) +
                                  "..."
                    ...
                    >
                      ...
                      {}
                      <div
                        className={`self-end flex items-center gap-1 font-mono text-[10px] tracking-wider select-none ${
